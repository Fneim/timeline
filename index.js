$(document).ready(function() {
  ...
  $("#create-event-button").click(function() {
    ...
    var eventContainer = $(".plot-container");
    ...
    var saveSpan = $(
      '<span class="save-button" onclick=save(this)>Save</span>'
    );
    var tags = $('<div class="tags"><p>some tags</p></div>');
    var textField = $(
      '<textarea type="text" placeholder="Write here...so what happened next?" required></textarea>'
    );
    var editSpan = $(
      '<span class="edit-button" onclick=edit(this)>Edit</span>'
    );
    var deleteSpan = $(
      '<span class="delete-button" onclick="deleteBtn(this)">Delete</span>'
    );
...
const deleteBtn = e => {
  ...
  confirmation.html(
    '<p>Are you sure you want to delete?<p><button value="yes">Yes</button><button value="no">No</button>'
  );
